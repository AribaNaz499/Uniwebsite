...
const Footer = () => {
    const instagramImages = [
        {
            src: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=100&h=100&fit=crop",
            alt: "Student graduating with cap and gown"
        },
        {
            src: "https://images.unsplash.com/photo-1564069114553-7215e1ff1890?w=100&h=100&fit=crop",
            alt: "Graduate hugging parents"
        },
        {
            src: "https://images.unsplash.com/photo-1577896851231-70ef18881754?w=100&h=100&fit=crop",
        ...
        {
            src: "https://images.unsplash.com/photo-1517486808906-6ca8b3f04846?w=100&h=100&fit=crop",
            alt: "Parents congratulating graduate"
        },
        {
            src: "https://images.unsplash.com/photo-1543269865-cbf427effbad?w=100&h=100&fit=crop",
            alt: "Teacher helping student"
        },
        {
            src: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&h=100&fit=crop",
            alt: "Female professor with students"
        },
        {
            src: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=100&h=100&fit=crop",
            alt: "Happy graduate throwing cap"
        },
        {
            src: "https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?w=100&h=100&fit=crop",
    ...
    return (
        ...
        >
            <Box  height={"95vh"} bg="rgba(10,20,40,0.85)" pb={5} w="100%" py={{ base: 10, md: 16 }} px={{ base: 6, md: 16 }}>
                ...
                >
                    ...
                    <Box
                        ...
                        position="absolute"
                        left="32%"  // Adjust this value to center the line
                         top="33%"
                    ...
                    <Box
                        display={{ base: "none", md: "block" }}
                        position="absolute"
                        left="54%"  // Adjust this value to center the line
                         top="33%"
                        transform="translateY(-50%)"
                        height="38%"
                        width="1px"
                    ...
                    <Box
                        display={{ base: "none", md: "block" }}
                        position="absolute"
                        left="74%"  // Adjust this value to center the line
                        top="33%"
                        transform="translateY(-50%)"
                        height="38%"
                        width="1px"
                ...
                <Box py={7} borderTop="1px solid rgba(255,255,255,0.2)" mt={24} pt={6}>
                    <Grid
                        px={2}
                        mt={13}
                        ...
                        alignItems="center"
                    >
                        <Text color="#cac7c7" fontSize="sm" pb={2}>  {/* ✅ pb={4} se copyright ke niche space */}
                            © Copyright 2026{" "}
